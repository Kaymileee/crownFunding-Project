  ...
  return (
    <div className="relative">
      <input
        id={name}
        type={type}
        className={`dark:bg-transparent dark:border-darkStroke dark:placeholder:text-text2 w-full px-6 py-4  border rounded-xl text-text1 text-sm font-medium placeholder:text-text4 ${
