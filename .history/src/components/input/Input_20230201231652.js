  ...
  return (
    <div className="relative">
      <input
        id={name}
        type={type}
        className={` w-full px-6 py-4  border rounded-xl text-text1 text-sm font-medium placeholder:text-black ${
          error?.message.length > 0 ? "border-error" : "border-strockColor"
        } ${
          children ? "pr-16" : ""
        } dark:bg-transparent dark:border-darkStroke dark:placeholder:text-text3 dark:text-white`}
