  ...
  return (
    <div className="bg-white rounded-xl py-10 px-[66px]">
      ...
      <form onSubmit={handleSubmit(handleAddNewCamp)}>
        ...
        <FormRow>
          ...
          <FormGroup>
            ...
            <Dropdown>
              ...
              <Dropdown.List>
                <Dropdown.Option onClick={() => {}}>Viet Nam</Dropdown.Option>
                <Dropdown.Option onClick={() => {}}>UK</Dropdown.Option>
                <Dropdown.Option onClick={() => {}}>USA</Dropdown.Option>
              </Dropdown.List>
            </Dropdown>
          </FormGroup>
        </FormRow>
        ...
        <div className="text-center">
          <Button type="submit" className="text-white bg-primary max-w-[177px]">
            Submit new campaign{" "}
          </Button>
        </div>
      </form>
