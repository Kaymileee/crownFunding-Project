...
const LayoutAuthentication = ({ children, heading = "" }) => {
  return (
    <div className="w-full min-h-screen bg-liteBg max-w-[1440px] mx-auto p-10 relative isolate dark:bg-[#13131A]">
      <img
        srcSet="/ellipse.png"
        alt="bg"
      ...
      <div className="w-full max-w-[556px] dark:bg-darkSecondary bg-white rounded-xl px-5 py-7 lg:px-16 lg:py-12 mx-auto">
