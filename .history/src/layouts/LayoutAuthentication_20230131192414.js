...
const LayoutAuthentication = ({ children, heading = "" }) => {
  return (
    <div className="w-full min-h-screen bg-liteBg max-w-[1440px] mx-auto p-10 relative isolate">
      <img
        srcSet="/ellipse.png"
        alt="bg"
      ...
      <div className="w-full max-w-[556px] bg-white rounded-xl px-5 py-7 lg:px-16 lg:py-12 mx-auto">
        <h1 className="text-lg font-semibold lg:text-xl text-center mb-1 lg:mb-3 text-text1">
          {heading}
        </h1>
        {children}
      </div>
